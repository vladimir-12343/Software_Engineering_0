...
## Задание 2
### Настройка
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_14-24-42.png)
## Выводы
Можно настроить личные данные, редактор, а так же просматривать список настроек с помощью команды git config --list

## Задание 3
### Создание нового репозитория
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_14-32-10.png)
## Выводы
Для связи между локальным репозиторием и удалённым нужно инициализирвоать репозиторий локально.
  
## Задание 4
### Подготовка файлов
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_14-47-30.png)
## Выводы
Есть команды для добавления одног офайла и проверки статуса файлов.

## Задание 5
### Фиксация изменений
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_14-49-16.png)
## Выводы
...
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_15-06-34.png)
## Выводы
...
## Задание 7
### Ветвление
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_15-27-19.png)
## Выводы
...
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_15-30-00.png)
## Выводы
...
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_15-35-59.png)
## Выводы
...
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_15-36-54.png)
## Выводы
git log / git diff - команды для отслеживания изменений в коммитах

## Задание 11
### Возвращение файла к предыдущему (определенному) состоянию
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_16-00-59.png)
## Выводы
...
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_16-04-18.png)
## Выводы
...
![Меню](https://github.com/vladimir-12343/Software_Engineering_0/blob/Тема_1/picc/2023-10-11_16-34-59.png)
